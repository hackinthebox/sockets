...
// child handling function, initiate sigaction to handle signals
void handle_children(void *handler) {
        ...
        struct sigaction sa;
        sa.sa_handler = handler; // set the handler function , that will reap dead procs
